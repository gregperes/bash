#
# Original file from https://github.com/fnando/bash/blob/master/scripts/prompt.sh
#
# Original Author: Nando Vieira
# Original Repo: https://github.com/fnando/bash
#
# Just made a several modifications for my use
#
__custom_prompt () {
  history -a
  history -c
